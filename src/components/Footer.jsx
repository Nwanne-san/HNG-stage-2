...
export default function Footer() {
  return (
    <>
      <div className={`w-full bg-pink text-neutral flex flex-col py-4 sm:[42px] px-6  ${lato.className}`}>
        ...
        <div className="flex lg:flex-row flex-col sm:gap-6 lg:gap-20 gap-6 sm:px-4 sm:py-2 w-full text-neutral">
            ...
            <div className="grid grid-cols-2 gap-14 sm:gap-20 w-full sm:flex">
              <div className="flex flex-col sm:flex-row sm:gap-6 lg:gap-20 gap-6  items-center">
