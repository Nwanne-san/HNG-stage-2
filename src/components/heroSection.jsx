    ...
    return (
        ...
        <div className="flex flex-col w-full text-[#FFFFFF] ">
            <div className="shop h-[471px] flex flex-col gap-6 justify-center items-center">
                <p className={`${playfair.className} text-center text-[32px] font-bold leading-10`}>Handcrafted Jewelry That Tells Your Unique Story</p>
                <p className={` text-[18px] leading-[21px] flex text-center  font-normal ${lato.className} `}>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 w-full">
                ...
                <div className='h-[313px] w-full text-secondary flex flex-col justify-end pl-[80px] pb-[70px] arrivals'>
