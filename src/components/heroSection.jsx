      ...
      <div className="flex flex-col w-full  text-[#FFFFFF] ">
        <div className="shop px-6 pb-[44px] pt-14  sm:h-[471px] flex flex-col  justify-center items-center">
          <div className="flex flex-col items-center gap-4 sm:gap-6 ">
            <p
              className={`${playfair.className} text-center text-[20px] sm:text-[32px] font-bold leading-[26px] sm:leading-10`}
            >
              Handcrafted Jewelry That Tells Your Unique Story
            </p>
            <p
              className={` sm:text-[18px] text-sm leading-[16px] sm:leading-[21px] lg:w-[694px] px-[38px] flex text-center  font-normal ${lato.className} `}
            >
              Explore our exclusive collection of artisanal jewelry,
              meticulously crafted to add a touch of sophistication to every
              moment. From elegant necklaces to stunning custom pieces, find the
              perfect adornment to celebrate your individuality.
            </p>
            <button
              onClick={handleStartShoppingClick}
              className={`${lato.className} font-bold px-6 py-4 text-center hover:bg-purple-950 duration-200 bg-pink rounded-xl focus:outline-none`}
            >
              Shop now
            </button>
          </div>
        ...
        <div className="flex sm:flex-row flex-col w-full">
          <div className="flex w-full">
            <div className="h-[140px] lg:h-[313px] w-full text-secondary flex flex-col justify-end pl-4 pb-2 lg:pl-[80px] lg:pb-[70px] products">
              <h3
                className={`${playfair.className} text-xl lg:text-[28px] leadin-[37.32px] font-semibold`}
              >
                All products
              </h3>
              <p className={`flex ${lato.className} font-medium `}>
                <Image src={Line} />
                <span>Explore</span>
              </p>
            </div>
