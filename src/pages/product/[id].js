...
import productItems from "@/data/productItems"; // Adjust path as necessary
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col items-center gap-4">
          <h1 className="text-pink text-xl sm:text-3xl font-semibold mt-4">
            {product.name}
          </h1>
          <Image
            src={product.imgSrc} // Update image source if necessary
            alt={product.name}
            width={300}
            height={300}
